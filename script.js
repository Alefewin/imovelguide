...
function calcularRegraDeTres() {
  ...
  var valorX = parseFloat(document.getElementById("valorX").value);

  if (isNaN(valorA) || isNaN(valorB) || isNaN(valorX)) {
    alert("Por favor, insira valores válidos em Valor A, Valor B e Valor X.");
    return;
  }

  var valorY = (valorX * valorB) / valorA;
...
function vertelefone() {
  ...
  // Fechar o modal ao pressionar "OK"
